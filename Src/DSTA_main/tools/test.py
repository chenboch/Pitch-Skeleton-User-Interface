...
def parse_args():
    ...
    parser.add_argument('--cfg', help='experiment configure file name', required=False, type=str,
                        default="./configs/posetimation/DSTA/posetrack17/model_inference.yaml")
    ...
    parser.add_argument('-weight', help='model weight file', required=False, type=str
                        , default='./checkpoints/epoch_19_state.pth')
...
def default_parse_args():
    ...
    parser.add_argument('--PE_Name', type=str, default='DSTA')
