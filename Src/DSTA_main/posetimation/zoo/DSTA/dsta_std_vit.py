...
from ..backbones.vision_transformer import VisionTransformer
...
class DSTA_STD_Vit(BaseModel):
    ...
    def __init__(self, cfg, phase, **kwargs):
        ...
        self.fc_coord = Linear(768, self.num_joints * self.embed_dim_ratio)
    ...
    def get_net(cls, cfg, phase, **kwargs):
        model = DSTA_STD_Vit(cfg, phase, **kwargs)
        return model
