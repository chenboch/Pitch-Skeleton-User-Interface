...
class Ui_video_widget(object):
    def setupUi(self, video_widget):
        ...
        self.gridLayout.addWidget(self.load_processed_video_btn, 1, 1, 1, 1)
    ...
    def retranslateUi(self, video_widget):
        ...
        self.start_code_btn.setText(_translate("video_widget", "開始分析"))
        ...
        item.setText(_translate("video_widget", "Conf."))
