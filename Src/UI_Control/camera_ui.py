...
class Ui_camera_ui(object):
    def setupUi(self, camera_ui):
        ...
        self.record_btn = QtWidgets.QPushButton(self.camera_setting_groupbox)
        self.record_btn.setMinimumSize(QtCore.QSize(150, 40))
        self.record_btn.setObjectName("record_btn")
        self.gridLayout.addWidget(self.record_btn, 1, 0, 1, 1)
    ...
    def retranslateUi(self, camera_ui):
        ...
        self.record_btn.setText(_translate("camera_ui", "開始錄影"))
