...
class Ui_camera_ui(object):
    def setupUi(self, camera_ui):
        ...
        self.analyze_checkBox = QtWidgets.QCheckBox(self.camer_setting_groupbox)
        self.analyze_checkBox.setObjectName("analyze_checkBox")
        self.gridLayout.addWidget(self.analyze_checkBox, 4, 2, 1, 1)
    ...
    def retranslateUi(self, camera_ui):
        ...
        self.analyze_checkBox.setText(_translate("camera_ui", "骨架分析"))
