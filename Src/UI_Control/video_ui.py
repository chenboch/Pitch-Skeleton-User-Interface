...
class Ui_video_widget(object):
    def setupUi(self, video_widget):
        ...
        self.gridLayout.addWidget(self.video_store_data_btn, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.load_video_btn, 4, 0, 1, 1)
        self.analyze_checkBox = QtWidgets.QCheckBox(self.file_groupbox)
        self.analyze_checkBox.setObjectName("analyze_checkBox")
        self.gridLayout.addWidget(self.analyze_checkBox, 1, 1, 1, 1)
        ...
        self.video_show_skeleton_checkBox = QtWidgets.QCheckBox(self.groupBox)
        ...
        self.horizontalLayout_5.addWidget(self.video_show_skeleton_checkBox)
        self.video_show_bbox_checkbox = QtWidgets.QCheckBox(self.groupBox)
        ...
        self.horizontalLayout_5.addWidget(self.video_show_bbox_checkbox)
    ...
    def retranslateUi(self, video_widget):
        ...
        self.analyze_checkBox.setText(_translate("video_widget", "骨架分析"))
        ...
        self.video_show_skeleton_checkBox.setText(_translate("video_widget", "人體骨架"))
        self.video_show_bbox_checkbox.setText(_translate("video_widget", "人物框"))
