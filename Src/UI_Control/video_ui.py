...
class Ui_video_widget(object):
    def setupUi(self, video_widget):
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.file_groupbox)
        ...
        self.video_load_data_btn = QtWidgets.QPushButton(self.file_groupbox)
        ...
        self.video_store_data_btn = QtWidgets.QPushButton(self.file_groupbox)
        ...
        self.video_analyze_btn = QtWidgets.QPushButton(self.file_groupbox)
    ...
    def retranslateUi(self, video_widget):
        ...
        self.video_load_data_btn.setText(_translate("video_widget", "讀取資料"))
        self.load_video_btn.setText(_translate("video_widget", "載入影片"))
        self.video_store_data_btn.setText(_translate("video_widget", "儲存資料"))
        self.video_analyze_btn.setText(_translate("video_widget", "開始分析"))
        ...
        self.label_4.setText(_translate("video_widget", "選定ID分析"))
        self.start_analyze_btn.setText(_translate("video_widget", "開始分析"))
        self.video_kpt_adjust_groupbox.setTitle(_translate("video_widget", "手動關節點修正"))
        self.video_show_skeleton_checkBox.setText(_translate("video_widget", "Show Skeleton"))
        self.video_show_bbox_checkbox.setText(_translate("video_widget", "Show BBox"))
        item = self.video_keypoint_table.horizontalHeaderItem(0)
        item.setText(_translate("video_widget", "Keypoint"))
