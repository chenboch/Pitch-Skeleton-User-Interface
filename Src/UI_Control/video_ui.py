...
class Ui_video_widget(object):
    def setupUi(self, video_widget):
        ...
        self.verticalLayout_3.addWidget(self.frame_view)
        self.curve_view = QtWidgets.QGraphicsView(video_widget)
        self.curve_view.setMaximumSize(QtCore.QSize(16777215, 200))
        ...
        self.verticalLayout_9.addWidget(self.keypoint_table)
        self.verticalLayout.addWidget(self.kpt_adjust_groupbox)
